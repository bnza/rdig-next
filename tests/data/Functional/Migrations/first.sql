...
CREATE TABLE `users_allowed_sites` (
  ...
  KEY `IDX_7644B8B6A76ED395` (`user_id`),
  KEY `IDX_7644B8B6F6BD1646` (`site_id`),
  CONSTRAINT `FK_7644B8B6A76ED395` FOREIGN KEY (`user_id`) REFERENCES `app_users` (`id`) ON DELETE CASCADE,
...
/*!50013 DEFINER=`rdig_test`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2020-04-06  0:06:46
