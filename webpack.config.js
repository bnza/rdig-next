...
Encore
   ...
   */
  .addEntry("app", "./assets/js/src/main.ts")
  ...
  .configureCssLoader(function(config) {
    if (Object.prototype.hasOwnProperty.call(config, "localIdentName")) {
      config.modules.localIdentName = config.localIdentName;
      delete config.localIdentName;
    }
  })
